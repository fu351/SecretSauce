 ...
 *
 * Usage:
 *   node scripts/test-target-geospatial.js
 */
...
async function testGeospatialIntegration() {
    // Dynamic import for TypeScript module (will be transpiled by Next.js)
    const { getNearestStore, getTargetProducts } = await import('../lib/scrapers/target.ts');
