...
ADD COLUMN IF NOT EXISTS grocery_distance_miles INTEGER DEFAULT 10;
...
COMMENT ON COLUMN profiles.grocery_distance_miles IS 'Maximum distance in miles for grocery store search';
