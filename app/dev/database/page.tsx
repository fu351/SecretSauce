...
const TABLES = [
  {
    ...
    tables: [
      ...
      { name: "recipe_collections", description: "User-named recipe folders" },
      ...
      { name: "post_flags", description: "Post moderation reports and resolution state" },
      { name: "post_likes", description: "Post reactions" },
      { name: "post_reposts", description: "Post repost activity" },
