...
import { getActiveProvider } from "@/backend/workers/standardizer-worker"
...
export async function POST(request: NextRequest) {
  try {
    ...
    const aiResults = await getActiveProvider().standardizeIngredients(normalizedInputs, { context: "pantry" })
