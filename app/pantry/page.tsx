      ...
      <div className="bg-white shadow-sm border-b dark:bg-[#181813] dark:border-[#e8dcc4]/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 md:py-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <h1 className={`text-2xl md:text-3xl font-bold ${pageTextClass}`}>My Pantry</h1>
              <p className={`${subTextClass} mt-1 text-sm md:text-base`}>Keep track of your ingredients and reduce food waste</p>
            </div>
