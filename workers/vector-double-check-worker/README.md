...
- Local one-shot:
  - `tsx --env-file=.env.local workers/vector-double-check-worker/resolve-vector-double-check.ts`
...
- `npm run test:run -- workers/vector-double-check-worker/__tests__/processor.test.ts`
