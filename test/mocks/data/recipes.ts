 ...
 * Updated to match new schema with JSONB content field
 */
export const mockRecipe: Recipe = {
  ...
  tags: ['vegetarian', 'contains-dairy', 'contains-gluten', 'contains-egg'],
  meal_type: 'snack',
  protein: undefined,
...
export const mockVeganAdvancedRecipe: Recipe = {
  ...
  content: {
    ...
    instructions: [
      ...
      { step: 5, description: 'Bake at 400°F for 35 minutes' },
    ],
  },
  tags: ['vegan', 'dairy-free'],
  meal_type: 'dinner',
...
export const mockRecipeList: Recipe[] = [
  ...
  mockVeganAdvancedRecipe,
  {
    ...
    tags: ['keto', 'low-carb', 'contains-dairy'],
    meal_type: 'dinner',
    protein: 'beef',
  },
  {
...
/**
 * Database row representation (as returned from Supabase)
 * This represents the raw DB format before mapping
 */
export const mockRecipeDbRow = {
  id: 'recipe-123',
  title: 'Chocolate Chip Cookies',
  prep_time: 15,
  cook_time: 12,
  servings: 24,
  difficulty: 'beginner',
  cuisine: 'american', // DB uses 'cuisine' not 'cuisine_name'
  author_id: 'user-456',
  rating_avg: 4.5,
  rating_count: 42,
  created_at: '2024-01-15T10:00:00Z',
  ...
  // Content is a JSONB field in DB
  content: {
    description: 'Classic chocolate chip cookies with a crispy exterior and chewy center',
    image_url: 'https://example.com/cookies.jpg',
    instructions: [
