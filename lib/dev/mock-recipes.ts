...
export const MOCK_RECIPES: MockRecipe[] = [
  ...
  {
    title: "NLP Test Sheet Pan Chicken and Veg",
    cuisine: "american",
    mealType: "dinner",
    protein: "chicken",
    difficulty: "beginner",
    ...
    description: "Sheet pan dinner with ingredient names formatted to exercise regex unit extraction.",
    imageUrl: "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?auto=format&fit=crop&w=900&q=80",
    instructions: [
      "Preheat oven to 425°F (220°C).",
      "Toss vegetables with oil and spices, then spread on a sheet pan.",
      "Add chicken and roast until cooked through.",
      "Serve with lemon wedges.",
    ],
    ingredients: [
      { name: "chicken thighs - 24oz" },
      { name: "baby potatoes - 1.5 lb" },
      { name: "green beans - 12 oz" },
  ...
  {
    title: "NLP Test Beef Ragu with Rigatoni",
    cuisine: "italian",
    mealType: "dinner",
    protein: "beef",
    difficulty: "intermediate",
    ...
    description: "Rich beef ragu with mixed-fraction and compact-unit ingredient strings.",
    ...
    instructions: [
      ...
      "Add tomato paste, crushed tomatoes, and herbs, then simmer.",
      "Cook rigatoni to al dente and toss with sauce.",
      "Serve hot with basil.",
    ],
    ingredients: [
      { name: "1 1/2 lb ground beef" },
      { name: "28oz crushed tomatoes" },
      { name: "2 tbsp tomato paste" },
      { name: "12oz rigatoni" },
      { name: "1/2 cup red wine" },
      { name: "2 ea garlic cloves" },
    ],
  },
  {
    title: "NLP Test Weekend Pancakes",
    cuisine: "american",
    mealType: "breakfast",
    protein: "egg",
    difficulty: "beginner",
    ...
    description: "Classic pancakes using leading quantity+unit ingredient text.",
    imageUrl: "https://images.unsplash.com/photo-1528207776546-365bb710ee93?auto=format&fit=crop&w=900&q=80",
    instructions: [
    ...
    ingredients: [
      ...
      { name: "1 1/2 cup whole milk" },
      { name: "2 ea eggs" },
      { name: "3 tbsp melted butter" },
      { name: "1 tbsp baking powder" },
      { name: "1 tsp vanilla extract" },
    ],
  },
  {
    title: "NLP Test Salmon Rice Bowls",
    cuisine: "japanese",
    mealType: "dinner",
    protein: "fish",
    difficulty: "intermediate",
    ...
    description: "Salmon bowls with unit aliases to validate dynamic standardization mappings.",
    imageUrl: "https://images.unsplash.com/photo-1467003909585-2f8a72700288?auto=format&fit=crop&w=900&q=80",
    instructions: [
      "Season salmon and roast until just cooked.",
      "Mix sauce ingredients and toss cucumbers lightly.",
      "Assemble bowls with rice, salmon, and vegetables.",
      "Top with sesame seeds.",
    ],
    ingredients: [
      { name: "salmon fillet - 20 oz" },
      { name: "2 cups cooked rice" },
      { name: "3 tblsp low sodium soy sauce" },
  ...
  {
    title: "NLP Test Black Bean Taco Night",
    cuisine: "mexican",
    mealType: "dinner",
    protein: "legume",
    difficulty: "beginner",
    ...
    description: "Fast tacos designed to exercise count and each/ea parsing.",
    imageUrl: "https://images.unsplash.com/photo-1551504734-5ee1c4a1479b?auto=format&fit=crop&w=900&q=80",
    instructions: [
      "Warm tortillas and heat beans with spices.",
      "Prep toppings while beans warm.",
      "Fill tortillas and finish with lime.",
      "Serve immediately.",
    ],
    ingredients: [
      { name: "12 ct flour tortillas" },
      { name: "2 cups canned black beans" },
      { name: "1 ea red onion" },
      { name: "2 tbsp lime juice" },
      { name: "avocado ea" },
      { name: "1 cup shredded lettuce" },
    ],
  },
  {
    title: "NLP Test Creamy Tomato Soup",
    cuisine: "french",
    mealType: "lunch",
    protein: "other",
    difficulty: "beginner",
    ...
    description: "Tomato soup with mixed formats for volume and packaged-size parsing.",
    imageUrl: "https://images.unsplash.com/photo-1547592166-23ac45744acd?auto=format&fit=crop&w=900&q=80",
    instructions: [
    ...
    ingredients: [
      { name: "14.5oz diced tomatoes" },
      { name: "1 qt vegetable broth" },
      { name: "1/2 cup heavy cream" },
      { name: "2 tbsp olive oil" },
      { name: "1 ea yellow onion" },
      { name: "2 ea garlic cloves" },
    ],
  },
  {
    title: "NLP Test Shrimp Stir-Fry",
    cuisine: "thai",
    mealType: "dinner",
    protein: "shellfish",
    difficulty: "intermediate",
    ...
    description: "Stir-fry with compact quantities and each abbreviations.",
    imageUrl: "https://images.unsplash.com/photo-1512058564366-c9e3c5b8051b?auto=format&fit=crop&w=900&q=80",
    instructions: [
      "Stir-fry shrimp until mostly cooked.",
      "Add vegetables and sauce and cook until crisp-tender.",
      "Finish with scallions and serve over rice.",
      "Garnish with lime.",
    ],
    ingredients: [
      { name: "1 1/2 lb shrimp" },
      { name: "8oz sugar snap peas" },
      { name: "2 tbsp oyster sauce" },
      { name: "1 tbsp fish sauce" },
      { name: "2 tsp sesame oil" },
      { name: "3 ea scallions" },
    ],
  },
  {
    title: "NLP Test Turkey Chili Mac",
    cuisine: "american",
    mealType: "dinner",
    protein: "turkey",
    difficulty: "intermediate",
    ...
    description: "One-pot turkey chili mac with quantities embedded directly in ingredient labels.",
    imageUrl: "https://images.unsplash.com/photo-1515516969-d4008cc6241a?auto=format&fit=crop&w=900&q=80",
    instructions: [
      "Brown turkey with onion and garlic.",
      "Add tomatoes, beans, spices, and stock and simmer.",
      "Stir in pasta and cook until tender.",
      "Top with cheese and serve.",
    ],
    ingredients: [
      { name: "1lb ground turkey" },
      { name: "15 oz kidney beans" },
      { name: "2 tbsp chili powder" },
      { name: "2 cups elbow macaroni" },
      { name: "1 cup shredded cheddar cheese" },
      { name: "1 ea yellow onion" },
    ],
  },
  {
    title: "NLP Test Miso Udon Bowl",
    cuisine: "japanese",
    mealType: "dinner",
    protein: "tofu",
    difficulty: "intermediate",
    ...
    prepTime: 12,
    cookTime: 15,
    tags: ["vegetarian", "contains-soy", "contains-gluten"],
    nutrition: {
      calories: 500,
      protein: 21,
      carbs: 61,
    ...
    description: "Miso udon bowl designed to test unit alias and fallback extraction behavior.",
    ...
    instructions: [
      ...
      "Add tofu and greens until warmed through.",
      "Serve noodles in broth and top with scallions.",
    ],
    ingredients: [
      { name: "16oz udon noodles" },
      { name: "4 cup vegetable broth" },
      { name: "3 tbsp white miso paste" },
      { name: "14 oz firm tofu" },
      { name: "2 ea scallions" },
      { name: "1 tbsp sesame seeds" },
    ],
  },
  {
    title: "NLP Test No-Unit Fallback Salad",
    cuisine: "american",
    mealType: "lunch",
    protein: "legume",
    difficulty: "beginner",
    ...
    description: "Includes a few intentionally odd unit tokens to push unit review fallback behavior.",
    imageUrl: "https://images.unsplash.com/photo-1540420773420-3366772f4999?auto=format&fit=crop&w=900&q=80",
    instructions: [
      "Combine all salad ingredients in a bowl.",
      "Whisk dressing and toss to coat.",
      "Adjust seasoning and serve chilled.",
      "Top with extra herbs.",
    ],
    ingredients: [
      { name: "2 ea ripe avocados" },
      { name: "1.5 cup canned chickpeas" },
      { name: "10oz cherry tomatoes" },
      { name: "1 glug extra virgin olive oil" },
      { name: "2 tbsp lemon juice" },
      { name: "fresh parsley ea" },
    ],
  },
]

const QUEUE_DRIFT_CUISINES: CuisineType[] = [
  "american",
  "italian",
  "mexican",
  "thai",
...
const QUEUE_DRIFT_PROTEINS: ProteinType[] = [
  "other",
  "beef",
  "pork",
  "chicken",
...
const QUEUE_DRIFT_TAGS: RecipeTag[][] = [
  ["contains-gluten"],
  ["contains-dairy"],
  ["contains-soy"],
  ["dairy-free"],
...
const QUEUE_DRIFT_INGREDIENT_POOL = [
  "Kroger® Thai Inspirations Pad Thai Sauce 8 fl oz",
  "Classic Jumbo Franks Hot Dogs 1 lb",
  "Kinder's The Taco Blend Mexican Seasoning",
  "Real Mayo",
  "Ménage à Trois Sweet Collection Dolce Red Blend Wine 750 ml",
  "Charles Shaw Nouveau Red Table Wine 2024",
  "Sargento Baby Swiss Sliced Cheese 11 Slices",
  "grab go angus roast beef fresh sliced deli meat",
  "sharp cheddar deli sliced cheese 12 slices",
  "low moisture part skim mozzarella string cheese",
  "nonstick canola cooking spray",
  "maruchan instant lunch beef flavor ramen noodle soup",
  "nongshim premium shin gold noodles",
  "kinder s classic beef bone broth gravy mix",
  "cage free large white egg",
  "natural cage free grade aa large brown egg",
  ...
  "egg",
  "1 low fat milk",
  "m maple grove farm sugar free maple flavor syrup kosher",
  "thai inspirations pad thai sauce",
  "angus roast beef deli sliced meat",
  "sargento swiss sliced cheese",
  "beef flavor ramen noodle soup",
  "grade aa large brown egg",
  "canola cooking spray",
  "freshly sliced deli roast beef",
  "classic franks hot dogs",
  "sweet collection dolce red blend wine",
  "kroger thai inspirations sauce",
  "deli sliced cheddar cheese",
  "premium instant lunch noodles",
  "low fat milk",
  "cage free egg",
  "mexican seasoning blend",
  "beef bone broth gravy mix",
  "red blend table wine",
  "brown egg large",
  "sliced deli meat roast beef",
  "jumbo beef franks",
  ...
  "thai peanut sauce",
  "pad thai sauce",
  "Simple Truth Organic Cage Free Brown Eggs Grade A Large 18 ct",
  "Kroger Carbmaster Fat Free Milk Ultra Filtered 52 fl oz",
  "Philadelphia Whipped Cream Cheese Spread 8 oz Tub",
  "Great Value Finely Shredded Mexican Style Cheese 16 oz",
  "Boar's Head Ovengold Roasted Turkey Breast Fresh Sliced Deli Meat",
  "Oscar Mayer Deli Fresh Rotisserie Seasoned Chicken Breast",
  "Tyson Fully Cooked Grilled and Ready Chicken Breast Strips",
  "Hillshire Farm Beef Smoked Sausage Rope 12 oz",
  "Johnsonville Original Recipe Breakfast Sausage Links",
  "Hebrew National Beef Franks Bun Length 12 oz",
  "Ball Park Angus Beef Hot Dogs 8 ct",
  "Applegate Natural Uncured Turkey Hot Dog",
  "Trader Joe's Fully Cooked Hardwood Smoked Uncured Bacon",
  "Hormel Black Label Thick Cut Bacon",
  "Kraft Singles American Cheese Slices 24 ct",
  "Tillamook Medium Cheddar Cheese Snack Portions",
  "Sargento Natural Colby Jack Cheese Sticks",
  "BelGioioso Fresh Mozzarella Snacking Cheese",
  "Cabot Seriously Sharp Cheddar Cheese Bar",
  "Kerrygold Pure Irish Butter Salted Sticks",
  "Challenge Unsalted Butter Sticks 16 oz",
  "Land O Lakes Half and Half 1 qt",
  "Organic Valley Heavy Whipping Cream 16 fl oz",
  "Horizon Organic 2 Percent Reduced Fat Milk",
  "Califia Farms Barista Blend Oat Milk",
  "Silk Unsweet Vanilla Almond Milk",
  "Chobani Non Fat Plain Greek Yogurt",
  "Fage Total 2 Percent Greek Yogurt",
  "Yoplait Original Strawberry Lowfat Yogurt Cup",
  "Daisy Pure and Natural Sour Cream",
  "Breakstone Cottage Cheese 2 Percent Milkfat",
  ...
  "French's Classic Yellow Mustard Squeeze",
  "Heinz Simply Tomato Ketchup No High Fructose Corn Syrup",
  ...
  "avocado oil spray",
  "Pam nonstick olive oil cooking spray",
  "Lawry's Seasoned Salt",
  "McCormick Taco Seasoning Mix Original",
  "Old El Paso Mild Taco Seasoning Mix",
  "Simply Organic Chili Powder",
  "ground black pepper fine grind",
  "pink himalayan salt grinder",
  "Everything Bagel Seasoning Blend",
  "Kinders Prime Steak with Black Garlic Seasoning",
  ...
  "Maruchan Instant Lunch Chicken Flavor Ramen Noodle Soup",
  "Shin Ramyun Spicy Beef Noodle Soup",
  ...
  "Minute Ready to Serve Jasmine Rice Cups",
  "Uncle Ben's Original Converted Rice",
  "Mahatma Extra Long Grain White Rice",
  ...
  "Dole Sliced Peaches in 100 Percent Juice",
  ...
  "Fresh Express Chopped Salad Kit Caesar",
  "Taylor Farms Asian Chopped Salad Kit",
  "Marketside Family Size Caesar Salad Kit",
  "Earthbound Farm Organic Spring Mix",
  "baby arugula triple washed",
  "romaine hearts 3 count bag",
  "organic baby spinach clamshell",
  "mini seedless cucumbers",
  "grape tomatoes medley",
  "cherry tomato medley",
  "sweet mini peppers",
  "yellow onion jumbo",
  "sweet onion vidalia",
  "russet potatoes 5 lb bag",
  "yukon gold potatoes 3 lb bag",
  "red potatoes whole",
  "bananas bunch",
  "honeycrisp apples bag",
  "gala apple",
  ...
  "yellow squash",
  "broccoli crowns",
  "cauliflower florets bag",
  "frozen steamable broccoli florets",
  "frozen mixed vegetables steam in bag",
  "frozen pizza rolls pepperoni",
  "frozen tater tots seasoned",
  "frozen burrito beef and bean",
  "frozen chicken nuggets family pack",
  "freezer pops assorted flavors",
  ...
  "Starbucks Cold Brew Coffee Unsweetened",
  ...
  "sweet red blend wine",
  "cooking white wine",
  "vermouth dry",
  "marsala cooking wine",
  "household paper towels 6 roll",
  "ultra soft toilet paper 12 mega roll",
  ...
  "charcoal briquettes original",
  "dog food chicken and rice recipe",
  "cat litter clumping unscented",
  "vitamin c gummies orange",
] as const

function buildQueueDriftMockRecipes(): MockRecipe[] {
  const recipeCount = 72
  const noisyPerRecipe = 6

  return Array.from({ length: recipeCount }, (_, index) => {
    const noisyIngredients: MockIngredient[] = Array.from({ length: noisyPerRecipe }, (_, slot) => {
      const poolIndex = (index * 5 + slot * 7) % QUEUE_DRIFT_INGREDIENT_POOL.length
      return { name: QUEUE_DRIFT_INGREDIENT_POOL[poolIndex] }
    })

    const suffix = String(index + 1).padStart(2, "0")

    return {
      title: `Queue Drift Stress Test ${suffix}`,
      cuisine: QUEUE_DRIFT_CUISINES[index % QUEUE_DRIFT_CUISINES.length],
      mealType: index % 3 === 0 ? "dinner" : index % 3 === 1 ? "lunch" : "snack",
      protein: QUEUE_DRIFT_PROTEINS[index % QUEUE_DRIFT_PROTEINS.length],
      difficulty: index % 2 === 0 ? "beginner" : "intermediate",
      servings: 4,
      prepTime: 10,
      cookTime: 20,
      tags: QUEUE_DRIFT_TAGS[index % QUEUE_DRIFT_TAGS.length],
      nutrition: {
        calories: 520,
        protein: 24,
        carbs: 42,
      ...
      description:
        "Synthetic stress-test recipe packed with noisy retail ingredient names to exercise queue canonicalization and unit cleanup.",
      instructions: [
        "Combine all listed ingredients in a prep workflow simulation.",
        "Normalize names and units, then resolve ingredients through the queue pipeline.",
        "Capture remap and skip outcomes for telemetry review.",
        "Persist results and verify no invalid category or long-title canonical regressions.",
      ],
      ingredients: [
        ...noisyIngredients,
        { name: "olive oil", quantity: 1, unit: "tbsp" },
...
export const QUEUE_DRIFT_MOCK_RECIPES: MockRecipe[] = buildQueueDriftMockRecipes()

MOCK_RECIPES.push(...QUEUE_DRIFT_MOCK_RECIPES)
