 ...
 *
 * Throws when:
 *   - The Ollama server is unreachable or returns a non-2xx status
 *   - The response payload is malformed or missing vectors
 *   - The request times out (AbortError → descriptive message)
 *
