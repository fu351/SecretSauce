...
class ProfileTable extends BaseTable<"profiles", ProfileRow, ProfileInsert, ProfileUpdate> {
  ...
  protected map(dbItem: any): Profile {
    return {
      ...
      meal_planner_weekly_reminder_enabled: dbItem.meal_planner_weekly_reminder_enabled ?? true,
      notification_email_digest_enabled: dbItem.notification_email_digest_enabled ?? true,
      notification_push_enabled: dbItem.notification_push_enabled ?? false,
