...
describe("Header mobile nav", () => {
  ...
  it("shows sleek bottom-nav menu with profile options", async () => {
    ...
    expect(screen.queryByRole("menuitem", { name: /discover/i })).not.toBeInTheDocument()
    expect(screen.queryByRole("menuitem", { name: /savings/i })).not.toBeInTheDocument()
    expect(screen.queryByRole("menuitem", { name: /streaks/i })).not.toBeInTheDocument()
    expect(screen.queryByRole("menuitem", { name: /kitchen sync/i })).not.toBeInTheDocument()
